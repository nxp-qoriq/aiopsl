...
#define PARSER_PRP_CREATE_STR  ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
				PARSER_PRP_CREATE_VERIF_CMDTYPE)

#define PARSER_PRP_DELETE_STR  ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
				PARSER_PRP_DELETE_VERIF_CMDTYPE)

#define PARSER_PRP_QUERY_STR  ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
				PARSER_PRP_QUERY_VERIF_CMDTYPE)

#define PARSER_GEN_PARSE_RES_STR  ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
				PARSER_GEN_PARSE_RES_VERIF_CMDTYPE)

#define PARSER_GEN_PARSE_RES_EXP_STR  ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
					PARSER_GEN_PARSE_RES_EXP_VERIF_CMDTYPE)

#define PARSER_PRP_ID_POOL_CREATE_STR ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
					PARSER_PRP_ID_POOL_CREATE_VERIF_CMDTYPE)

#define PARSER_INIT_FOR_VERIF_STR ((CTLU_PARSE_CLASSIFY_MODULE << 16) | \
					PARSER_INIT_FOR_VERIF_CMDTYPE)
/**************************************************************************//**
