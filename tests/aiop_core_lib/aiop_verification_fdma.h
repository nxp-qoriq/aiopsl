...
#define FDMA_INIT_CMD_STR	((FPDMA_MODULE << 16) | FDMA_INIT_CMD)
	/** FDMA Initial frame presentation explicit Command Structure
	 * identifier */
#define FDMA_INIT_EXP_CMD_STR	((FPDMA_MODULE << 16) | FDMA_INIT_EXP_CMD)
	/** FDMA Present Data segment Command Structure identifier */
#define FDMA_PRESENT_CMD_STR	((FPDMA_MODULE << 16) | FDMA_PRESENT_CMD)
	/** FDMA Read ASA segment Command Structure identifier */
#define FDMA_READ_ASA_CMD_STR	((FPDMA_MODULE << 16) | FDMA_READ_ASA_CMD)
	/** FDMA Read PTA segment Command Structure identifier */
#define FDMA_READ_PTA_CMD_STR	((FPDMA_MODULE << 16) | FDMA_READ_PTA_CMD)
	/** FDMA Present Data segment explicit Command Structure identifier */
#define FDMA_PRESENT_EXP_CMD_STR ((FPDMA_MODULE << 16) | FDMA_PRESENT_EXP_CMD)
	/** FDMA Extend presentation Command Structure identifier */
#define FDMA_EXTEND_CMD_STR	((FPDMA_MODULE << 16) | FDMA_EXTEND_CMD)
	/** FDMA Store working frame Command Structure identifier */
#define FDMA_STORE_DEFAULT_WF_CMD_STR	((FODMA_MODULE << 16) | \
		FDMA_STORE_DEFAULT_WF_CMD)
	/** FDMA Store working frame Command Structure identifier */
#define FDMA_STORE_WF_CMD_STR	((FODMA_MODULE << 16) | FDMA_STORE_WF_CMD)
	/** FDMA Enqueue working frame Command Structure identifier */
#define FDMA_ENQUEUE_WF_CMD_STR	((FODMA_MODULE << 16) | FDMA_ENQUEUE_WF_CMD)
	/** FDMA Enqueue working frame explicit Command Structure identifier */
#define FDMA_ENQUEUE_WF_EXP_CMD_STR ((FODMA_MODULE << 16) | 		\
		FDMA_ENQUEUE_WF_EXP_CMD)
	/** FDMA Enqueue FD Command Structure identifier */
#define FDMA_ENQUEUE_FRAME_CMD_STR	((FODMA_MODULE << 16) |	\
		FDMA_ENQUEUE_FRAME_CMD)
	/** FDMA Enqueue FD explicit Command Structure identifier */
#define FDMA_ENQUEUE_FRAME_EXP_CMD_STR	((FODMA_MODULE << 16) |	\
		FDMA_ENQUEUE_FRAME_EXP_CMD)
	/** FDMA Discard default frame Command Structure identifier */
#define FDMA_DISCARD_DEFAULT_WF_CMD_STR	((FODMA_MODULE << 16) |	\
		FDMA_DISCARD_DEFAULT_WF_CMD)
	/** FDMA Discard working frame Command Structure identifier */
#define FDMA_DISCARD_WF_CMD_STR	((FODMA_MODULE << 16) | FDMA_DISCARD_WF_CMD)
	/** FDMA Terminate Task Command Structure identifier */
#define FDMA_TERMINATE_TASK_CMD_STR	((FODMA_MODULE << 16) |	\
		FDMA_TERMINATE_TASK_CMD)
	/** FDMA Replicate frame Command Structure identifier */
#define FDMA_REPLICATE_CMD_STR	((FODMA_MODULE << 16) | FDMA_REPLICATE_CMD)
	/** FDMA Concatenate frames Command Structure identifier */
#define FDMA_CONCAT_CMD_STR	((FODMA_MODULE << 16) | FDMA_CONCAT_CMD)
	/** FDMA Split working frame Command Structure identifier */
#define FDMA_SPLIT_CMD_STR	((FODMA_MODULE << 16) | FDMA_SPLIT_CMD)
	/** FDMA Trim working frame segment Command Structure identifier */
#define FDMA_TRIM_CMD_STR	((FODMA_MODULE << 16) | FDMA_TRIM_CMD)
	/** FDMA Modify working frame segment Command Structure identifier */
#define FDMA_MODIFY_CMD_STR	((FODMA_MODULE << 16) | FDMA_MODIFY_CMD)
	/** FDMA Replace working frame segment Command Structure identifier */
#define FDMA_REPLACE_CMD_STR	((FODMA_MODULE << 16) | FDMA_REPLACE_CMD)
	/** FDMA Insert working frame segment Command Structure identifier */
#define FDMA_INSERT_DATA_CMD_STR ((FODMA_MODULE << 16) | FDMA_INSERT_DATA_CMD)
	/** FDMA Delete working frame segment Command Structure identifier */
#define FDMA_DELETE_DATA_CMD_STR ((FODMA_MODULE << 16) | FDMA_DELETE_DATA_CMD)
	/** FDMA Delete working frame segment Command Structure identifier */
#define FDMA_CLOSE_SEG_CMD_STR ((FODMA_MODULE << 16) | FDMA_CLOSE_SEG_CMD)
	/** FDMA Replace working frame ASA segment Command Structure
	 * identifier */
#define FDMA_REPLACE_ASA_CMD_STR ((FODMA_MODULE << 16) | FDMA_REPLACE_ASA_CMD)
	/** FDMA Replace working frame PTA segment Command Structure
	 * identifier*/
#define FDMA_REPLACE_PTA_CMD_STR ((FODMA_MODULE << 16) | FDMA_REPLACE_PTA_CMD)
/** FDMA Insert explicit working frame segment Command Structure identifier */
#define FDMA_INSERT_EXP_DATA_CMD_STR ((FODMA_MODULE << 16) | 		\
		FDMA_INSERT_EXP_DATA_CMD)
	/** FDMA Checksum working frame command Structure identifier */
#define FDMA_CKS_CMD_STR	((FODMA_MODULE << 16) | FDMA_CKS_CMD)
	/** FDMA Copy data command Structure identifier */
#define FDMA_COPY_CMD_STR	((FODMA_MODULE << 16) | FDMA_COPY_CMD)
	/** FDMA Acquire buffer command Structure identifier */
#define FDMA_ACQUIRE_BUFFER_CMD_STR 	((FODMA_MODULE << 16) | 	\
		FDMA_ACQUIRE_BUFFER_CMD)
	/** FDMA Release buffer command Structure identifier */
#define FDMA_RELEASE_BUFFER_CMD_STR	((FODMA_MODULE << 16) | 	\
		FDMA_RELEASE_BUFFER_CMD)
	/** FDMA Create Frame command Structure identifier */
#define FDMA_CREATE_FRAME_CMD_STR ((FODMA_MODULE << 16) | 		\
		FDMA_CREATE_FRAME_CMD)
	/** FDMA Create FD command Structure identifier */
#define FDMA_CREATE_FD_CMD_STR ((FODMA_MODULE << 16) | 		\
		FDMA_CREATE_FD_CMD)
