...
6. Copy “frag1.pcap", "frag2.pcap", "frag3.pcap", "frag4.pcap" from aiopsl\misc\setup into to simulator folder

===========================================
Execution flow
===========================================
1. Build mc_app from mc_release_0.4.2 using CW_APP_v10.0.8.
2. Build ipr_demo from aiopsl using CW_APP_v10.0.8.
3. Run simulator:
   ./ccssim2 -port 42333
...
10. Run “tio inject” to inject all 4 fragments:
   ./fm_tio_inject -hub localhost:42975 -ser w0_m1 -file <frag1-4.pcap> -verbose_level 2
...
6. The user can run with "IPR_DEMO_WITH_HM" flag (set ipr_demo_flags in app_process_packet_flow0()).
   This will cause modification of IP destination address for the fragments,
   and udp destination port for the reassembled frame.
