...
6. Copy following pcap files from aiopsl\misc\setup into to simulator folder:
 	...
 	frag3.pcap
 	frag4.pcap
 7. Set ipr_demo_flags in ipr_demo.c either to IPR_DEMO_WITH_HM ot IPR_DEMO_WITHOUT_HM. 
...
13. In the simulator directory you will get a pcap output file: w0_m1.pcap.
	This file should imclude the reassembled frame, which must be identical to:
